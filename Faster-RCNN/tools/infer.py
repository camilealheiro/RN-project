...
def infer(args):
    ...
    faster_rcnn_model.roi_head.low_score_threshold = 0.5
    ...
    for _ in tqdm(range(10)):
        ...
        cv2.imwrite(f'samples/output_frcnn_gt_{base_name}.png', gt_im)
        ...
        cv2.imwrite(f'samples/output_frcnn_{base_name}.jpg', im)
